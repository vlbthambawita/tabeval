...
EVAL_PRIVACY_DISCLOSURE_KNOWN=""       # e.g. "--eval-privacy-disclosure-known age,gender" (required if EVAL_PRIVACY_DISCLOSURE is set)
EVAL_PRIVACY_DISCLOSURE_SENSITIVE=""   # e.g. "--eval-privacy-disclosure-sensitive label" (required if EVAL_PRIVACY_DISCLOSURE is set)
EVAL_PRIVACY_DISCLOSURE_CONTINUOUS=""  # optional: e.g. "--eval-privacy-disclosure-continuous age"
